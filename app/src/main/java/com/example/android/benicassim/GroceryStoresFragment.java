...
public class GroceryStoresFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        locations.add(new Location(getString(R.string.grocery_store_name_5), getString(R.string.grocery_store_description_5), getString(R.string.grocery_store_web_5), getString(R.string.grocery_store_address_5), getString(R.string.grocery_store_phone_5), getString(R.string.grocery_store_opening_hours_5)));
